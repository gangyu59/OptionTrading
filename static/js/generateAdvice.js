...
async function generateAdvice(symbol, macdData, kdjData, stockData) {
    ...
    console.log(`MACD Signal: ${macdSignal}, MACD Hist: ${macdHist}, K: ${k}, D: ${d}, Current Price: ${currentPrice}`);
    ...
    if (macdHist > 0 || (macdSignal > 0 && k > d)) {
        ...
        console.log(`Call Option - Strike Price: ${optionDetails.strikePrice}, Option Price: ${optionDetails.optionPrice}`);
        ...
        console.log(`Put Option - Strike Price: ${optionDetails.strikePrice}, Option Price: ${optionDetails.optionPrice}`);
        if (optionDetails.optionPrice <= optionDetails.maxPremium) {
            return {
