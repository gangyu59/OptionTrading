...
// 全局化函数
window.getBollingerBandsRecommendation = getBollingerBandsRecommendation;
window.getMACDRecommendation = getMACDRecommendation;
window.getKDJRecommendation = getKDJRecommendation;
window.getRSIRecommendation = getRSIRecommendation;
window.getMARecommendation = getMARecommendation;
window.getATRRecommendation = getATRRecommendation;
window.getADXRecommendation = getADXRecommendation;
window.getStochasticRecommendation = getStochasticRecommendation;
window.getOverallRecommendation = getOverallRecommendation;